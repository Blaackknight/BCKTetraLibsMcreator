...
@SuppressWarnings({ "unused", "NotNullFieldNotInitialized" }) public class LevelingEntity extends GeneratableElement
    ...
    @ModElementReference
    @TextureReference(TextureType.ENTITY) @ResourceReference("model")
    public List<net.mcreator.element.types.LivingEntity.ModelLayerEntry> modelLayers;

    @ModElementReference @ResourceReference("animation") public List<net.mcreator.element.types.LivingEntity.AnimationEntry> animations;
    ...
    private LevelingEntity() {
        this(null);
    }

    public LevelingEntity(ModElement element) {
        super(element);
