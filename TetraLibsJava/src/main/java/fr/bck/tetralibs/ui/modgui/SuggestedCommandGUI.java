...
public class SuggestedCommandGUI extends ModElementGUI<SuggestedCommand> implements IBlocklyPanelHolder {
    ...
    public SuggestedCommandGUI(MCreator mcreator, ModElement modElement, boolean editingMode) {
    ...
    protected void initGUI() {
        ...
        blocklyPanel.addTaskToRunAfterLoaded(() -> {
            ...
            blocklyPanel.addChangeListener(
                    changeEvent -> new Thread(fr.bck.tetralibs.ui.modgui.SuggestedCommandGUI.this::regenerateArgs, "CommandRegenerate").start());
            if (!isEditingMode()) {
    ...
    @Override public void openInEditingMode(SuggestedCommand command) {
    ...
    @Override public SuggestedCommand getElementFromGUI() {
        SuggestedCommand command = new SuggestedCommand(modElement);
